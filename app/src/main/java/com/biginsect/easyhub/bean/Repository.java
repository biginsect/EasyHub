...
import com.biginsect.easyhub.bean.filter.TrendingSince;
...
public class Repository implements Parcelable{
    ...
    protected Repository(Parcel in) {
        ...
        permissions = in.readParcelable(RepositoryPermissions.class.getClassLoader());
        long tmpPushedAt = in.readLong();
        pushedAt = tmpPushedAt == -1 ? null : new Date(tmpPushedAt);
        ...
        sinceStargazersCount = in.readInt();
        int tmpSince = in.readInt();
        since = tmpSince == -1 ? null : TrendingSince.values()[tmpSince];
    }
